...
VALUES
    (1, 'Zane Johnson', 16, 'CLS101'),
    (2, 'Nina White', 18, 'CLS102'),
    (3, 'Ian Miller', 16, 'CLS103'),
    (4, 'Alice Williams', 15, 'CLS104'),
    (5, 'Jane Taylor', 17, 'CLS101'),
    (6, 'Mike Miller', 14, 'CLS102'),
    (7, 'Rachel Garcia', 14, 'CLS103'),
    (8, 'Ian White', 14, 'CLS104'),
    (9, 'Wendy Thompson', 17, 'CLS101'),
    (10, 'Alice Thompson', 15, 'CLS102'),
    (11, 'Rachel Johnson', 17, 'CLS103'),
    (12, 'Alice Williams', 14, 'CLS104'),
    (13, 'Wendy Williams', 14, 'CLS101'),
    (14, 'Rachel Martin', 17, 'CLS102'),
    (15, 'Nina Rodriguez', 16, 'CLS103'),
    (16, 'Tina White', 18, 'CLS104'),
    (17, 'Fiona Smith', 16, 'CLS101'),
    (18, 'David Williams', 16, 'CLS102'),
    (19, 'Wendy Johnson', 15, 'CLS103'),
    (20, 'Steve Davis', 18, 'CLS104'),
    (21, 'Hannah Martinez', 16, 'CLS101'),
    (22, 'Ethan Smith', 17, 'CLS102'),
    (23, 'Jane Smith', 17, 'CLS103'),
    (24, 'Paula Jones', 16, 'CLS104'),
    (25, 'Yara Rodriguez', 15, 'CLS101'),
    (26, 'Jane Martin', 16, 'CLS102'),
    (27, 'Amber Jones', 14, 'CLS103'),
    (28, 'Ethan Anderson', 14, 'CLS104'),
    (29, 'Wendy Smith', 15, 'CLS101'),
    (30, 'Zane Garcia', 14, 'CLS102');
